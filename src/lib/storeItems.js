...
export const STORE_ITEMS = [
  ...
  // ── SUBSCRIPTIONS ─────────────────────────────────────────────
  {
    ...
    rarity: "rare",
    perks: [
      "300 monthly credits allowance",
      "Monthly credits refresh instead of stacking",
      "Create community tournaments",
      "Enter tournaments and official competitions",
      "Ranked Player vs Player matches",
      "Ranked Club vs Club matches",
      "Advanced player and club discovery",
      "Analytics, form, and opponent context",
      "Premium profile and club customization tools",
    ],
  },
];
