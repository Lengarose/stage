...
export default function GameDayDressingRoom({ game, myClub, myPlayer, user, onSeatChange, hasCustomBackground = false }) {
  ...
  return (
    <div className={cn(
      "relative overflow-hidden border p-4 [clip-path:polygon(18px_0,100%_0,calc(100%_-_18px)_100%,0_100%)] sm:p-5",
      hasCustomBackground
        ? "border-white/25 bg-black/55 shadow-[0_0_34px_-24px_rgba(238,243,251,0.72)]"
        : "border-[#eef3fb]/26 bg-[#141a24] shadow-[inset_0_0_90px_rgba(0,0,0,0.46),0_0_34px_-24px_rgba(238,243,251,0.72)]",
    )}>
      {!hasCustomBackground ? (
      ...
      <div className="relative z-[1] space-y-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          ...
          <span className="w-fit border border-white/20 bg-black/45 px-3 py-1.5 font-heading text-[10px] font-black uppercase tracking-[0.16em] text-white [clip-path:polygon(8px_0,100%_0,calc(100%_-_8px)_100%,0_100%)]">
      ...
      {/* Match started lock */}
      {matchStarted && (
        <div className="flex items-center gap-2 border border-white/15 bg-black/60 px-3 py-2">
          ...
          className={cn(
            ...
            iAmSeated
              ...
              : iAmAvailable
                ...
                : "cursor-not-allowed border-white/25 bg-black/60 text-white"
          )}
        >
          {iAmSeated ? (
      ...
      <div className="grid grid-cols-2 gap-2 md:grid-cols-3 xl:grid-cols-4">
        ...
        <div className="col-span-full border border-dashed border-white/25 bg-black/45 p-5 text-center text-[11px] uppercase tracking-widest text-white">
