  ...
  return [
    { label: t("nav.home"), items: homeItems },
    {
      ...
      items: [
        ...
        { path: "/competitions",    icon: Star,      label: t("nav.gost") },
        { path: "/leagues",         icon: Globe2,    label: t("nav.regionalLeagues") },
  ...
  return [
    {
      ...
      items: [
        ...
        { path: "/admin/leagues", icon: Globe2, label: t("admin.nav.leagues") },
        { path: "/admin/gost", icon: Star, label: t("admin.nav.gost") },
...
const ADMIN_MOBILE_MORE_GROUPS = [
  ...
  },
  {
    ...
    items: [
      { path: "/admin/leagues", icon: Globe2, label: "Regional Leagues" },
      { path: "/admin/gost", icon: Star, label: "GOST" },
