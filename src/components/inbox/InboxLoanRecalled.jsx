...
export default function InboxLoanRecalled({ message }) {
  ...
  return (
    <div className="mt-4 space-y-3 rounded-xl border border-white/10 bg-black/30 p-4">
      <p className="text-xs uppercase tracking-wider text-white/45">
        {tx("commonPages.loanRecalled", "Loan recalled")}
      </p>
      ...
      <p className="text-sm text-muted-foreground">
        {tx("commonPages.loanRecalledNotice", "Playing rights have returned to the parent club. No response is required.")}
      </p>
