    ...
    <div className="space-y-1.5">
      ...
      <div className="flex gap-2 items-center">
        {value ? (
          ...
          <div className="w-12 h-12 rounded-lg border border-dashed border-border bg-muted/40 flex items-center justify-center shrink-0">
...
export default function LandingPageEditor() {
  ...
  function buildForm(r) {
    return {
      ...
      footer_tagline:    r.footer_tagline    ?? "The premier competitive football gaming platform.",
    };
  }
    ...
    <div className="space-y-4 max-w-2xl">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <Button
          ...
          onClick={handleSave}
          disabled={saving}
          className={cn("h-8 text-xs gap-1.5", saved ? "bg-success text-white" : "bg-primary text-primary-foreground")}
        >
          {saving
      ...
      <EditorSection title="Footer">
        <Field label="Tagline">
          <Input value={form.footer_tagline} onChange={e => set("footer_tagline", e.target.value)} className="h-8 text-xs" />
        </Field>
      ...
      <Button
        ...
        onClick={handleSave}
        disabled={saving}
        className={cn("w-full h-9 text-xs gap-1.5 mt-2", saved ? "bg-success text-white" : "bg-primary text-primary-foreground")}
      >
        {saving
          ? <span className="w-3 h-3 border-2 border-primary-foreground/30 border-t-primary-foreground rounded-full animate-spin inline-block" />
          : <Check className="w-3.5 h-3.5" />}
