...
export default function PresidentContractInfo() {
  return (
    <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4 space-y-3">
      <div className="flex items-start gap-2">
        <Info className="w-4 h-4 text-primary shrink-0 mt-0.5" />
        <div>
          <p className="font-bold text-sm text-foreground mb-2">Club President & Player Contracts</p>
          <div className="space-y-2 text-xs text-muted-foreground">
            <div className="flex items-start gap-2">
              <Briefcase className="w-3.5 h-3.5 text-primary shrink-0 mt-0.5" />
              <p><span className="text-primary font-semibold">President Contract:</span> Defines your role as club president. 3,650 days duration.</p>
            </div>
            <div className="flex items-start gap-2">
            ...
            <p className="text-muted-foreground mt-3 p-2 rounded-lg bg-secondary/30">
              ⭐ Club presidents can hold <strong>up to 2 contracts</strong>: 1 president contract + 1 player contract.
            </p>
          </div>
        </div>
      </div>
