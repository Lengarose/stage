...
export default function Social() {
  ...
  function incrementCommentsCount(postId) {
            ...
            {posts.map(post => {
              ...
              return (
                <div key={post.id} ref={(node) => {
                  ...
                  <PostCard post={post} user={user} onLike={toggleLike} onDelete={deletePost} onCommentCreated={incrementCommentsCount} focusCommentId={post.id === targetPostId ? targetCommentId : null} />
                </div>
              );
            })}
          </div>
...
function PostCard({ post, user, onLike, onDelete, onCommentCreated, focusCommentId }) {
  const { t } = useTranslation();
