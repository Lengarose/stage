...
export default function Admin(props) {
  ...
  async function reseedLifestyle() {
    ...
    try {
      ...
      const existing = await stageClient.entities.LifestyleItem.list("sort_order", 500).catch(() => []);
      await Promise.all(existing.map(i => stageClient.entities.LifestyleItem.delete(i.id).catch(() => {})));

      // 2. Insert correct items (1 STC ≈ $1 USD — May 2026 market data)
      const DEFAULTS = [
        // ── Houses & Apartments ────────────────────────────────────────
        { name: 'Studio Apartment', category: 'houses', tier: 'standard', sort_order: 1, description: 'A compact modern studio in the city centre. Good starter investment.', price_stc: 280000, rent_price_stc: 2200, rent_duration_days: 30, invest_price_stc: 280000, invest_return_rate: 7, invest_duration_days: 30, passive_income_stc: 2500, passive_income_interval_days: 7, weekly_maintenance_stc: 800, can_buy: true, can_rent: true, can_invest: true, can_sell: true, sell_value_percent: 80, allows_multiple: true, is_active: true },
        { name: 'City Apartment',   category: 'houses', tier: 'premium',  sort_order: 2, description: 'Stylish city apartment with modern finishes. Strong rental yield.', price_stc: 750000, rent_price_stc: 4500, rent_duration_days: 30, invest_price_stc: 750000, invest_return_rate: 9, invest_duration_days: 30, passive_income_stc: 7000, passive_income_interval_days: 7, weekly_maintenance_stc: 2000, can_buy: true, can_rent: true, can_invest: true, can_sell: true, sell_value_percent: 82, allows_multiple: true, is_active: true },
        { name: 'Penthouse Suite',  category: 'houses', tier: 'elite',    sort_order: 3, description: 'Top-floor penthouse with panoramic views and private terrace.', price_stc: 8000000, rent_price_stc: 35000, rent_duration_days: 30, invest_price_stc: 8000000, invest_return_rate: 11, invest_duration_days: 30, passive_income_stc: 75000, passive_income_interval_days: 7, weekly_maintenance_stc: 22000, can_buy: true, can_rent: true, can_invest: true, can_sell: true, sell_value_percent: 85, allows_multiple: true, is_active: true },
        { name: 'Luxury Villa',     category: 'houses', tier: 'legendary',sort_order: 4, description: 'Stunning private villa with pool and landscaped grounds.', price_stc: 18000000, rent_price_stc: 80000, rent_duration_days: 30, invest_price_stc: 18000000, invest_return_rate: 13, invest_duration_days: 30, passive_income_stc: 175000, passive_income_interval_days: 7, weekly_maintenance_stc: 48000, can_buy: true, can_rent: true, can_invest: true, can_sell: true, sell_value_percent: 88, allows_multiple: true, is_active: true },
        // ── Cars ──────────────────────────────────────────────────────
        { name: 'Hatchback',  category: 'cars', tier: 'standard',  sort_order: 10, description: 'A reliable daily driver. Gets you from A to B in style.', price_stc: 28000, rent_price_stc: 800, rent_duration_days: 30, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 200, can_buy: true, can_rent: true, can_invest: false, can_sell: true, sell_value_percent: 60, allows_multiple: false, is_active: true },
        { name: 'SUV',        category: 'cars', tier: 'premium',   sort_order: 11, description: 'Premium large SUV with luxury interior and all-terrain capability.', price_stc: 95000, rent_price_stc: 3500, rent_duration_days: 30, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 550, can_buy: true, can_rent: true, can_invest: false, can_sell: true, sell_value_percent: 62, allows_multiple: false, is_active: true },
        { name: 'Sports Car', category: 'cars', tier: 'elite',     sort_order: 12, description: 'Sleek two-door performance machine. Turn heads everywhere.', price_stc: 260000, rent_price_stc: 9000, rent_duration_days: 7, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 2000, can_buy: true, can_rent: true, can_invest: false, can_sell: true, sell_value_percent: 65, allows_multiple: false, is_active: true },
        { name: 'Hypercar',   category: 'cars', tier: 'legendary', sort_order: 13, description: 'The pinnacle of automotive engineering. Pure performance and prestige.', price_stc: 350000, rent_price_stc: 18000, rent_duration_days: 3, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 4500, can_buy: true, can_rent: true, can_invest: false, can_sell: true, sell_value_percent: 68, allows_multiple: false, is_active: true },
        // ── Watches ───────────────────────────────────────────────────
        { name: 'Steel Sport Watch', category: 'watches', tier: 'standard',  sort_order: 20, description: 'A precision-engineered sport timepiece. Quality and durability.', price_stc: 9500, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 9500, invest_return_rate: 4, invest_duration_days: 60, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: true, can_sell: true, sell_value_percent: 70, allows_multiple: true, is_active: true },
        { name: 'Luxury Watch',      category: 'watches', tier: 'premium',   sort_order: 21, description: 'Hand-crafted Swiss precision timepiece. A statement of status.', price_stc: 38000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 38000, invest_return_rate: 7, invest_duration_days: 60, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: true, can_sell: true, sell_value_percent: 78, allows_multiple: true, is_active: true },
        { name: 'Diamond Watch',     category: 'watches', tier: 'legendary', sort_order: 22, description: "Diamond-encrusted masterpiece. The ultimate collector's statement.", price_stc: 120000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 120000, invest_return_rate: 10, invest_duration_days: 90, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: true, can_sell: true, sell_value_percent: 82, allows_multiple: true, is_active: true },
        // ── Fashion ───────────────────────────────────────────────────
        { name: 'Designer Outfit',   category: 'fashion', tier: 'standard',  sort_order: 30, description: 'Premium tailored fashion for match days and press conferences.', price_stc: 5000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: false, can_sell: false, sell_value_percent: 0, allows_multiple: true, is_active: true },
        { name: 'Luxury Collection', category: 'fashion', tier: 'elite',     sort_order: 31, description: 'Full seasonal wardrobe from Gucci, Dior, and Off-White.', price_stc: 80000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: false, can_sell: false, sell_value_percent: 0, allows_multiple: true, is_active: true },
        { name: 'Exclusive Drops',   category: 'fashion', tier: 'legendary', sort_order: 32, description: 'Limited edition streetwear haul. Off-White, Fear of God, Supreme.', price_stc: 22000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: false, can_sell: false, sell_value_percent: 0, allows_multiple: true, is_active: true },
        // ── VIP Experiences ───────────────────────────────────────────
        { name: 'VIP Match Day',      category: 'vip_experiences', tier: 'standard', sort_order: 40, description: 'Executive box seat and VIP hospitality at any STAGE match.', price_stc: 12000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: false, can_sell: false, sell_value_percent: 0, allows_multiple: true, is_active: true },
        { name: 'Award Show Access',  category: 'vip_experiences', tier: 'premium',  sort_order: 41, description: 'Attend the prestigious STAGE annual awards ceremony.', price_stc: 65000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: false, can_sell: false, sell_value_percent: 0, allows_multiple: true, is_active: true },
        { name: 'Private Yacht Day',  category: 'vip_experiences', tier: 'elite',    sort_order: 42, description: 'Exclusive private yacht charter for a day on the Mediterranean.', price_stc: 200000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: false, can_sell: false, sell_value_percent: 0, allows_multiple: true, is_active: true },
        // ── Personal Services ─────────────────────────────────────────
        { name: 'Personal Trainer', category: 'personal_services', tier: 'standard', sort_order: 50, description: 'Elite personal trainer dedicated to your fitness and performance.', price_stc: 120000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: false, can_sell: false, sell_value_percent: 0, allows_multiple: false, is_active: true },
        { name: 'Private Chef',     category: 'personal_services', tier: 'premium',  sort_order: 51, description: 'Michelin-trained private chef preparing nutritionally optimised meals.', price_stc: 200000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: false, can_sell: false, sell_value_percent: 0, allows_multiple: false, is_active: true },
        { name: 'Media Team',       category: 'personal_services', tier: 'elite',    sort_order: 52, description: 'Dedicated media and PR team managing your public image and brand.', price_stc: 450000, rent_price_stc: 0, rent_duration_days: 0, invest_price_stc: 0, invest_return_rate: 0, invest_duration_days: 0, passive_income_stc: 0, passive_income_interval_days: 0, weekly_maintenance_stc: 0, can_buy: true, can_rent: false, can_invest: false, can_sell: false, sell_value_percent: 0, allows_multiple: false, is_active: true },
      ];

      await stageClient.entities.LifestyleItem.bulkCreate(DEFAULTS);
