...
// Public read-only tournament details. Brackets and match lists are part of the
// tournament page and should be visible to everyone; mutations remain protected.
app.get('/api/stage/public/tournaments/:id', async (req, res) => {
  try {
...
app.get('/api/stage/public/tournaments/:id/matches', async (req, res) => {
  try {
    const { EXECUTESQL } = require('./server/db/database');
