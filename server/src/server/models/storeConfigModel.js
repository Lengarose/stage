  ...
  create() {
    ...
    return EXECUTESQL(
      `INSERT INTO store_configs (
        ...
        headline, description, perks, is_active, created_date, updated_date
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())`,
      [
        ...
        this.community_tournament_limit, this.headline, this.description, perks,
  ...
  update(id) {
    ...
    return EXECUTESQL(
      `UPDATE store_configs SET
        ...
        starter_credits=?, tournament_entry_credits=?, community_tournament_limit=?,
        headline=?, description=?, perks=?, is_active=?, updated_date=NOW()
      WHERE id=?`,
      [
