...
async function runStartupMigrations() {
  ...
  await addCol('players', 'career_tile_backgrounds', 'JSON NULL');
  await addCol('players', 'game_day_tile_backgrounds', 'JSON NULL');
  ...
  await EXECUTESQL(`CREATE TABLE IF NOT EXISTS admin_mail_messages (
    id                  VARCHAR(36)   PRIMARY KEY,
